...
public function cart(){
    ...
    $shipping = Cart::orderBy('id', 'desc')->value('Shipping');
    return view('frontend.cart', ['products' => $products, 'shipping' => $shipping]);
}
...
public function checkout(Request $request)
    {
        ...
        return view('frontend.checkout', ['products' => $products, 'shipping' => $shipping]);
    ...
    public function ret_categories(Request $request)
{
    ...
    public function ret_edit_category(Request $request, $id){
        ...
        $category->category_display_title = $request->input('category_display_title');
