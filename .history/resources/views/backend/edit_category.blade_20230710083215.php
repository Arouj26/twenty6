        ...
        <div class="col-xxl">
          <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="category_display_name">Category Display Title</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="category_display_name" name="category_display_name" value="{{$categories['category_display_name']}}"/>
                      <div class="mt-2">@error('category_display_name')
                      <div class="alert alert-danger">{{"Title is required" }}</div>
                      @enderror</div>
                  </div>
                </div>
