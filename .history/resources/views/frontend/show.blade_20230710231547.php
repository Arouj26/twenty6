...
@section('content')
                                ...
                                <li>
                                    ...
                                    <div class="size__btn">
                                        ...
                                        <div class="size-labels" id="size-labels-{{ $variant['product_color'] }}" style="display: none;">
                                            ...
                                            <label for="{{ $variantItem['product_size'] }}" style="display: inline-block; padding: 5px; border: 2px solid #CA1515;">
    ...
    <script>
        $(document).ready(function() {
          ...
          $("input[name='size__radio']").change(function() {
            if ($(this).is(":checked")) {
              $(this).closest(".size-labels").find("label").css("color", "red");
            } else {
              $(this).closest(".size-labels").find("label").css("color", "#666666");
            }
          });
        });
        </script>
