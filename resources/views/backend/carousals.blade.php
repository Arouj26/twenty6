        ...
        <div class="col-xxl">
          <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
              <h5 class="mb-0">Add carousels</h5>
            </div>
            <div class="card-body">
              <form action="{{url('/admin/homesettings/carousals/')}}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="carousal_tag">Carousel Tag</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="carousal_tag" name="carousal_tag" />
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="carousal_text" name="carousal_text" />
