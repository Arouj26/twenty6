      ...
      <div class="row">
        ...
        <div class="col-xxl">
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form action="{{url('/admin/homesettings/categories/')}}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="category_display_title" name="category_display_title" />
