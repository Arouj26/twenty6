                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{url('frontend/img/dresses/dresses-1.jpg')}}">
                                    <div class="label new">New</div>
                                    <ul class="product__hover">
                                        <li><a href="{{url('frontend/img/dresses/dresses-1.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                                        <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                        <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="#">Black spring dress</a></h6>
                                    <div class="rating">
                                    ...
                                    <div class="product__price">Rs. 5,400</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{url('frontend/img/dresses/dresses-2.jpg')}}">
                                    <ul class="product__hover">
                                        <li><a href="{{url('frontend/img/dresses/dresses-2.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                                        <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                        <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="#">BW Coat</a></h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                    ...
                                    <div class="product__price">Rs. 8,800</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{url('frontend/img/dresses/dresses-3.jpg')}}">
                                    <ul class="product__hover">
                                        <li><a href="{{url('frontend/img/dresses/dresses-3.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                                        <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                        <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="#">Flowy Pink Skirt</a></h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                    ...
                                    <div class="product__price">Rs. 4,000</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
